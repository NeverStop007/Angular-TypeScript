...
export class CustomerServiceService {
  ...
  private addCustomerUrl = 'http://localhost:8080/api/customer/create';

  private updateCustomerUrl = 'http://localhost:8080/api/customer/update';

  private deleteCustomerUrl = 'http://localhost:8080/api/customer/delete';

  private editCustomerUrl = 'http://localhost:8080/api/customer/edit';

  private fetchCustomersUrl = 'http://localhost:8080/api/customer/fetch';
  ...
  updateCustomer(customerObject:Customer):Observable<number> {
    ...
    return this.http.put(this.updateCustomerUrl, customerObject, ajaxOptions).pipe(
